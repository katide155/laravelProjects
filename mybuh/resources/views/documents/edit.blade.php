	...
	<form action="{{route('company.update', [$company])}}" method="POST">
	  ...
	  <div class="modal-body">
		<div class="row g-3 align-items-center">
		  ...
		  <div class="col-6">
			<input type="text" id="company_type" name="company_type" class="form-control" value="{{$company->company_type}}">
		  </div>
		</div>
	  </div>
	  <div class="modal-body">
		<div class="row g-3 align-items-center">
		  ...
		  <div class="col-6">
			<input type="textarea" id="company_description" name="company_description" class="form-control" value="{{$company->company_description}}">
		  </div>
		</div>
	  </div>
	@csrf  
